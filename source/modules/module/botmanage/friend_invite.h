#ifndef MIGANGBOT_MODULES_MODULE_FRIEND_INVITE_H_
#define MIGANGBOT_MODULES_MODULE_FRIEND_INVITE_H_
...
inline void FriendInvite::Handle_friend_invite(const Event &event, onebot11::ApiBot &bot)
{

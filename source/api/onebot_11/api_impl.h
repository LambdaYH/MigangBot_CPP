...
inline Json CallApi(const std::string &action, const Json &params) {
  return Json{{"action", action}, {"params", params}};
}

inline Json handle_quick_operation_message_reply(const Event &event,
...
inline Json handle_quick_operation_message_delete(const Event &event,
                                                  MsgId message_id) {
  Event msg;
  msg["action"] = ".handle_quick_operation";
  msg["params"]["context"] = {
  ...
  msg["params"]["operation"] = {{"delete", true}, {"message_id", message_id}};
  return msg;
}

inline Json handle_quick_operation_message_kick(const Event &event,
                                                MsgId message_id,
  ...
  msg["params"]["operation"] = {{"kick", true},
                                {"reject_add_request", reject_add_request}};
  return msg;
}

inline Json handle_quick_operation_message_ban(const Event &event,
  ...
  msg["params"]["operation"] = {{"ban", true}, {"ban_duration", ban_duration}};
  return msg;
}

inline Json handle_quick_operation_request_friend(const Event &event,
                                                  bool approve) {
  Event msg;
  msg["action"] = ".handle_quick_operation";
  msg["params"]["context"] = {{"anonymous", event.value("anonymous", nullptr)},
                              {"post_type", "request"},
                              {"request_type", "friend"},
                              {"flag", event["flag"].get<std::string>()}};
  msg["params"]["operation"] = {{"approve", approve}};
  return msg;
}

inline Json handle_quick_operation_request_group(const Event &event,
  ...
  msg["params"]["context"] = {{"anonymous", event.value("anonymous", nullptr)},
                              ...
                              {"request_type", "group"},
                              {"sub_type", sub_type}};
  msg["params"]["operation"] = {{"reason", reason}, {"approve", approve}};
  return msg;
}

inline Json send_private_msg(QId user_id, const std::string &message,
                             bool auto_escape) {
...
inline Json send_group_msg(QId group_id, const std::string &message,
                           bool auto_escape) {
...
inline Json send_msg(const QId qid, const GId gid, const std::string &message,
                     bool auto_escape) {
  Event msg;
  msg["action"] = "send_msg";
  msg["params"] = {{"user_id", qid},
                   {"group_id", gid},
                   {"message", message},
                   {"auto_escape", auto_escape}};
...
inline Json send_like(const QId qid, uint8_t time) {
  ...
  msg["params"] = {{"user_id", qid}, {"time", time}};
  return msg;
}

inline Json set_group_kick(const GId gid, const QId qid,
                           const std::string &message,
                           bool reject_add_request) {
  Event msg;
  msg["action"] = "set_group_kick";
  msg["params"] = {{"group_id", gid},
                   {"user_id", qid},
                   {"message", message},
                   {"reject_add_request", reject_add_request}};
  return msg;
...
inline Json set_group_ban(const GId gid, const QId qid, uint32_t duration) {
  ...
  msg["params"] = {{"group_id", gid}, {"user_id", qid}, {"duration", duration}};
  return msg;
}

inline Json set_group_anonymous_ban(const GId gid, int32_t duration,
                                    const std::string &anonymous_flag) {
  Event msg;
...
inline Json set_group_whole_ban(const GId gid, bool enable) {
  ...
  msg["params"] = {{"group_id", gid}, {"enable", enable}};
  return msg;
}
...
inline Json set_group_admin(const GId gid, const QId qid, bool enable) {
  ...
  msg["params"] = {{"group_id", gid}, {"user_id", qid}, {"enable", enable}};
  return msg;
}
...
inline Json set_group_card(const GId gid, const QId qid,
                           const std::string &card) {
  Event msg;
  msg["action"] = "set_group_card";
  msg["params"] = {{"group_id", gid}, {"user_id", qid}, {"card", card}};
  return msg;
}
...
inline Json set_group_name(const GId gid, const std::string &name) {
  ...
  msg["params"] = {{"group_id", gid}, {"name", name}};
  return msg;
}
...
inline Json set_group_special_title(const GId gid, const QId qid,
  ...
  msg["params"] = {
      {"group_id", gid}, {"user_id", qid}, {"special_title", special_title}};
  return msg;
}
...
inline Json set_group_add_request(const std::string &flag,
                                  const std::string &sub_type,
                                  const std::string &reason, bool approve) {
  return CallApi("set_group_add_request", Json{{"flag", flag},
                                               {"sub_type", sub_type},
                                               {"reason", reason},
                                               {"approve", approve}});
}
...
inline Json get_group_member_info(const GId gid, const QId qid, bool no_cache) {
  ...
  msg["params"] = {{"group_id", gid}, {"user_id", qid}, {"no_cache", no_cache}};
  return msg;
}
...
inline Json get_group_member_list(const GId gid, bool no_cache) {
  ...
  msg["params"] = {{"group_id", gid}, {"no_cache", no_cache}};
  return msg;
}
...
inline Json get_group_honor_info(const GId gid, const std::string &type) {
  ...
  msg["params"] = {{"group_id", gid}, {"type", type}};
  return msg;
}
...
inline Json get_record(const std::string &file, const std::string &out_format) {
  ...
  msg["params"] = {{"file", file}, {"out_format", out_format}};
  return msg;
}
...
inline Json send_group_notice(const GId gid, const std::string &content,
                              const std::string &image) {
  Event msg;
  msg["action"] = "_send_group_notice";
  msg["params"] = {{"group_id", gid}, {"content", content}, {"image", image}};
  return msg;
}

inline Json set_model_show(const std::string &model,
                           const std::string &model_show) {
  Event msg;
  msg["action"] = "_set_model_show";
  msg["params"] = {{"model", model}, {"model_show", model_show}};
  return msg;
}

...
public:
    ...
    void HelpMsg(const Event &event, std::function<void(const std::string &)> &notify);
private:
...
inline void Help::HelpMsg( const Event &event, std::function<void(const std::string &)> &notify)
{
